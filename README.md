...
* helper: helper folder with list of functions only called by others file
...
4. Save the token into MongoDB, open iteung db, create a profile collection and insert this JSON document with your 30-day token and WhatsApp number.  
...
1. Open Menu Cloud Scheduler. Just search it like the screenshot.  
