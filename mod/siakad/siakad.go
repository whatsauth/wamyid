...
func LoginSiakad(message itmodel.IteungMessage, db *mongo.Database) string {
	...
	if resp.StatusCode == http.StatusInternalServerError {
		return "Gagal login, email atau password salah. Jika kamu mengakses Siakad dengan SSO Google, harap cek/ganti password terlebih dahulu dan coba lagi login di domyikado."
	}
